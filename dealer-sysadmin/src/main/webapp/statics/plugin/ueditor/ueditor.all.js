        ...
        render: function (container,holder) {
            ...
            if (container) {
                ...
                if (options.customDomain && document.domain != location.hostname) {
                    html=html.replace("</head>","<script>window.onload=function(){window.parent.UE.instants[\'ueditorInstant"+ me.uid + "\']._setup(document);}</script></head>");
                    html += '</html>';
        ...
        editor.render = function (holder) {
            ...
            utils.domReady(function () {
                ...
                function renderUI() {
                    ...
                    editor.container.style.width = 'auto';
