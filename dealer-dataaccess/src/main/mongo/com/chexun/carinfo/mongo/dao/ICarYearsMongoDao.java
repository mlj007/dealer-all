 /**     
   * @create.date: 2012-3-19 下午04:21:33
   * @author: lfz 
   * @company: 车马驿站
 ...
 * @author: lfz
 * @modify.by: lfz
 * @modify.date: 2012-3-19 下午04:21:33
 */
public interface ICarYearsMongoDao {
	/**
	 * 新增/更新记录
	 * 
	 * @param bean
	 ...
	 * @
	 */
	public List<CarYearsMongo> find(Object query, Object orderBy, int limit, int skip)
			;
	public List<?> find(Object query,Object fields, Object orderBy,int limit, int skip)
			;
	/**
	 * 获取全部记录
	 * 
