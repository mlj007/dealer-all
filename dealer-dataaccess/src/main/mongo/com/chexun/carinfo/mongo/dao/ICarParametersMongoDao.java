 ...
 */
public interface ICarParametersMongoDao {
	/**
	 * 新增/更新记录
	 * 
	 * @param bean
	 ...
	 * @
	 */
	public List<CarParametersMongo> find(Object query,Object filed, Object orderBy, int limit, int skip)
			;
	public List<CarParametersMongo> find(Object query, Object orderBy, int limit, int skip)
	;
	/**
	 * 获取全部记录
	 * 
