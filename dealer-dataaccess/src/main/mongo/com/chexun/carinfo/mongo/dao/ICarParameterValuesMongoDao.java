 /**     
   * @create.date: 2012-3-20 下午12:28:29
   * @author: lfz 
   * @company: 车马驿站
 ...
 * @author: lfz
 * @modify.by: lfz
 * @modify.date: 2012-3-20 下午12:28:29
 */
public interface ICarParameterValuesMongoDao {
	/**
	 * 新增/更新记录
	 * 
	 * @param bean
	 ...
	 * @
	 */
	public List<CarParameterValueMongo> find(Object query, Object orderBy, int limit, int skip)
			;
