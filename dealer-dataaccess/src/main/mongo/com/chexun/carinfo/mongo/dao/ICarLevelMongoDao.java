 /**     
   * @create.date: 2012-3-19 下午03:24:51
   * @author: lfz 
   * @company: 车马驿站
 ...
 * @author: lfz
 * @modify.by: lfz
 * @modify.date: 2012-3-19 下午03:24:51
 */
public interface ICarLevelMongoDao {
	/**
	 * 新增/更新记录
	 * 
	 * @param bean
	 ...
	 * @
	 */
	public List<CarLevelMongo> find(Object query, Object orderBy, int limit, int skip)
			;
