 /**     
   * @create.date: 2012-3-19 下午03:53:28
   * @author: lfz 
   * @company: 车马驿站
 ...
 * @author: lfz
 * @modify.by: lfz
 * @modify.date: 2012-3-19 下午03:53:28
 */
public interface ICarModelMongoDao {
	/**
	 * 新增/更新记录
	 * 
	 * @param bean
	 ...
	 * @
	 */
	public List<CarModelMongo> find(Object query, Object orderBy, int limit, int skip)
			;
	/**
	 * 根据查询条件查询数据
	 * 
	 ...
	 * @
	 */
	public List<CarModelMongo> find(Object queryObject, Object fieldsObject,
