 /**     
   * @create.date: 2012-3-19 下午04:02:39
   * @author: lfz 
   * @company: 车马驿站
 ...
 * @author: lfz
 * @modify.by: lfz
 * @modify.date: 2012-3-19 下午04:02:39
 */
public interface ICarParameterOptionsMongoDao {
	/**
	 * 新增/更新记录
	 * 
	 * @param bean
	 ...
	 * @
	 */
	public List<CarParameterOptionsMongo> find(Object query, Object orderBy, int limit, int skip)
			;
