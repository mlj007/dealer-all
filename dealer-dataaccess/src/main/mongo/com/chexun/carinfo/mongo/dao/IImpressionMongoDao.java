 ...
 */
public interface IImpressionMongoDao {
	/**
	 * 新增/更新记录
	 * 
	 * @param bean
	 ...
	 * @
	 */
	public List<ImpressionMongo> find(Object query, Object orderBy, PageInfo pageInfo)
			;
	 ...
	 * @
	 */
	public List<ImpressionMongo> find(Object query, Object field,Object orderBy,
			int limit,int skip) ;
