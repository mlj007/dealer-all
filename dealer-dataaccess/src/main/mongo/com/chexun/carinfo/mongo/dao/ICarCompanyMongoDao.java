 /**     
   * @create.date: 2012-3-19 上午11:36:55
   * @author: lfz 
   * @company: 车马驿站
 ...
 * @author: lfz
 * @modify.by: lfz
 * @modify.date: 2012-3-19 上午11:36:55
 */
public interface ICarCompanyMongoDao {
	/**
	 * 新增/更新记录
	 * 
	 * @param bean
	 ...
	 * @
	 */
	public List<CarCompanyMongo> find(Object query, Object orderBy, int limit, int skip)
			;
