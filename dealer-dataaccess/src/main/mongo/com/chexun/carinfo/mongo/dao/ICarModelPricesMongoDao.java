 /**     
   * @create.date: 2012-3-19 下午03:56:09
   * @author: lfz 
   * @company: 车马驿站
 ...
 * @author: lfz
 * @modify.by: lfz
 * @modify.date: 2012-3-19 下午03:56:09
 */
public interface ICarModelPricesMongoDao {
	/**
	 * 新增/更新记录
	 * 
	 * @param bean
	 ...
	 * @
	 */
	public List<CarModelPricesMongo> find(Object query, Object orderBy, int limit, int skip)
			;
